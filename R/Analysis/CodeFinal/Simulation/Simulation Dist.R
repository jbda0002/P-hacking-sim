...
figuredist<-as.data.table(finalresults[finalresults$SampleSize==200 & finalresults$Correlation ==0.2 & finalresults$IndependentVariables==1
                                       & finalresults$Type!=3 & finalresults$Type!=4 & finalresults$Type!=5 & finalresults$Type!=6,])
figuredist<-figuredist[figuredist$Power2==1 & figuredist$Power3==2 & figuredist$Power12==2 & figuredist$Power13==2|
                         figuredist$Power2==2 & figuredist$Power3==1 & figuredist$Power12==2 & figuredist$Power13==2|
                         figuredist$Power2==2 & figuredist$Power3==2 & figuredist$Power12==2 & figuredist$Power13==2|
...
figuredist<-as.data.table(finalresults[finalresults$IndependentVariables==1 & finalresults$SampleSize ==200 & finalresults$OutlierExclusion==2
                                       & finalresults$Type!=3 & finalresults$Type!=4 & finalresults$Type!=5 & finalresults$Type!=6,])
figuredist<-figuredist[figuredist$Power2==1 & figuredist$Power3==2 & figuredist$Power12==2 & figuredist$Power13==2|
                         figuredist$Power2==2 & figuredist$Power3==1 & figuredist$Power12==2 & figuredist$Power13==2|
                         figuredist$Power2==2 & figuredist$Power3==2 & figuredist$Power12==2 & figuredist$Power13==2|
...
figuretwodata<-as.data.table(falsepostive[falsepostive$SampleSize==200 & falsepostive$Correlation==0.2
                                          & falsepostive$Type!=3 & falsepostive$Type!=4 & falsepostive$Type!=5 & falsepostive$Type!=6,]
)
...
figuretwodatadiff <- merge(first,second, by=c("Main","Set","Type","IndependentVariables")) 
figuretwodatadiff$diff=figuretwodatadiff$mean.x-figuretwodatadiff$mean.y

## Calculate the added effect of one more covariate
first=figuretwodatadiff[figuretwodatadiff$IndependentVariables==1]
second=figuretwodatadiff[figuretwodatadiff$IndependentVariables==2]

figuretwodatadiff2 <- merge(first,second, by=c("Main","Set","Type")) 
figuretwodatadiff2$AddVariable=figuretwodatadiff2$diff.y-figuretwodatadiff2$diff.x


Figure2 = ggplot(figuretwodatadiff)+
  geom_bar(aes(x=Set,y=diff), stat = "identity",position="dodge")+
  facet_grid(Type+IndependentVariables~Main)+
  theme_apa()+
  xlab("Model set")+
  ylab("Difference between false-positive rate")+
  theme(axis.text.x = element_text(color = "grey20", size = 17, angle = 65, hjust = .5, vjust = .5, face = "plain"),
