...
names(TableModelsFalse)=c("Model sets" , "x + z" ,"x * z","z * z", "x + z + x * z" , "x + z + z * z","X * Cov + Cov * Cov", "ME + X * Cov + Cov * Cov", "Number of total models")
...
names(TableModelsFalseML)=c("Model sets" , "x + z" ,"z * z" , "x + z + z * z", "Number of total models")
...
names(TableModelsTrue)=c("Model sets" , "x + z" ,"x * z","z * z", "x + z + x * z" , "x + z + z * z","X * Cov + Cov * Cov", "ME + X * Cov + Cov * Cov", "Number of total models")
...
names(TableModelsTrueML)=c("Model sets", "x + z", "x + z + z * z", "Number of total models")
...
### Latest version does not use total numbers, so remove this row
TableModelsTrue_t = TableModelsTrue_t[-8,]
TableModelsFalse_t = TableModelsFalse_t[-8,]
## Save tables 
comment          <- list()
comment$pos      <- list()
