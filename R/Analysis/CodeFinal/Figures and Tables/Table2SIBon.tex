...
% Wed Feb 03 15:49:09 2021
\begin{longtable}{lccccccccc}
\caption{False positive probability (FPP) and false positive ratio (FPR) with Bonferroni correction for the different model sets with different levels of correlations between the dependent variable and the covariates.} \\ 
  \hline
