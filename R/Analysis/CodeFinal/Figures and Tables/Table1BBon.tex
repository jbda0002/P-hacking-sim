...
% Thu Jan 28 15:27:41 2021
\begin{table}[ht]
\centering
\caption{False positive probability (FPP) and false positive ratio (FPR) for the different model sets when using multiple outlier criteria and Bonferroni correction.} 
\label{tab:apptabBC2}
\scalebox{0.8}{
