...
% Thu Jan 28 15:27:42 2021
\begin{table}[ht]
\centering
\caption{False positive probability (FPP) and false positive ratio (FPR) for the different model sets when using three covariates and Bonferroni correction.} 
\label{tab:apptabBC3}
\scalebox{0.8}{
