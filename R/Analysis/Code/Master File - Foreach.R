...
## Save the figures
ggsave(figureNormal,filename =file.path("Analysis/Result/Figures","figureNormalv2.jpeg"),width = 6.64,height = 5.70)
ggsave(figureBin,filename =file.path("Analysis/Result/Figures","figureBinv2.jpeg"),width = 6.64,height = 5.70)
ggsave(figureNormBin,filename =file.path("Analysis/Result/Figures","figureNormBinv2.jpeg"),width = 6.64,height = 5.70)
ggsave(figureBinNorm,filename =file.path("Analysis/Result/Figures","figureBinNormv2.jpeg"),width = 6.64,height = 5.70)

## Save the result file
write.csv(finalresult,"Analysis/Result/ResultFile/Resultsv2.csv" )
