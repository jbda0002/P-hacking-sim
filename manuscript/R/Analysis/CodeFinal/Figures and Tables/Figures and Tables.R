...
load("results1000obs-part1.Rdata")
load("results1000obs-part2.Rdata")
finalresults2=finalresults
load("results1000obs-part3.Rdata")
finalresults3=finalresults
load("results1000obs-part4.Rdata")
finalresults4=finalresults
load("results1000obs-part5.Rdata")
finalresults5=finalresults
finalresults=rbind(finalresults1,finalresults2,finalresults3,finalresults4,finalresults5)
...
figuredata<-falsepostive[falsepostive$SampleSize==200 & falsepostive$OutlierExclusion=="FALSE" & falsepostive$IndependentVariables==1 & falsepostive$Correlation==0.2
...
figuredata<-as.data.table(falsepostive[falsepostive$SampleSize==200  & falsepostive$IndependentVariables==1 & falsepostive$Correlation==0.2
                                       & falsepostive$Type!="h1=Normal, Co=Binary" & falsepostive$Type!="h1=Binary, Co=Normal"
                                       & falsepostive$Type!="h1=Binary, Co=Binary Effect" & falsepostive$Type!="h1=Normal, Co=Binary Effect",]
)
...
figuredata<-as.data.table(falsepostive[falsepostive$SampleSize==200  & falsepostive$OutlierExclusion=="FALSE" & falsepostive$Correlation==0.2
                                       & falsepostive$Type!="h1=Normal, Co=Binary" & falsepostive$Type!="h1=Binary, Co=Normal"
                                       & falsepostive$Type!="h1=Binary, Co=Binary Effect" & falsepostive$Type!="h1=Normal, Co=Binary Effect",]
)
...
figuredata<-as.data.table(falsepostive[ falsepostive$OutlierExclusion=="FALSE" & falsepostive$Correlation==0.2 & falsepostive$IndependentVariables==1
                                        & falsepostive$Type!="h1=Normal, Co=Binary" & falsepostive$Type!="h1=Binary, Co=Normal"
                                        & falsepostive$Type!="h1=Binary, Co=Binary Effect" & falsepostive$Type!="h1=Normal, Co=Binary Effect"
