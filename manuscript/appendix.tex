...
\centering
\caption{Difference in the false positive probability and false positive ratio comapred to the base model in Figure S7 when using one more covariate (three in total). Black bars denote the added effect to the false positive probability and red bars denote the added effect to the false positive ratio. The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
