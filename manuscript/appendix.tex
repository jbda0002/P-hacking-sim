...
Figure S12 shows the FPP and FPR for the full model sets under different conditions. Here there is no split between each model set.
...
\centering
\caption{The probability of the FPP and FPR given different model sets, the presence of main effects when having interactions (i.e., MAIN = TRUE or MAIN = FALSE) and different distributions of the variable of interest and covariates. Sample size was set to 200, a correlation between the dependent variable and covariates was \textit{r}=0.2 and we used two covariates. The FPP is shown in black and the FPR in red. Here binary variables are both dummy coded but also effects coded.}
...
\centering
\caption{Difference in FPP and FPR compared to the base model in Figure S1 when step-wise increasing the correlation between the dependent variable and covariates from covariates and=0.2 to covariates and=0.4. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in FPP and FPR compared to the base model in Figure S1 when using two dependent variables and the average of the two (meaning three dependent variables in total). The correlation between the dependent variables is set to r=0.5. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in FPP and FPR compared to the base model in Figure S1 when using multiple outlier criteria. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in the FPP and FPR compared to the base model in Figure S1 when using one more covariate (three in total). Black bars denote the added effect to the FPP and red bars denote the added effect to the FPR. The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Effect of increasing sample size for each model set and all combinations of data distributions (i.e., binary and normal). Black denotes the FPP and red denotes the FPR. The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{The description of this figure is the same as for Figure S1 with the only difference being that we applied Bonferroni correction. This figure therefore shows the probability of the FPP and FPR given different model sets, the presence of main effects when having interactions (i.e., MAIN = TRUE or MAIN = FALSE) and different distributions of the variable of interest and covariates. Sample size was set to 200, a correlation between the dependent variable and covariates was \textit{r}=0.2 and we used two covariates. The FPP is shown in black and the FPR in red. Here binary variables are both dummy coded but also effects coded.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in the FPP and FPR compared to the base model in Figure S7 when step-wise increasing the correlation between the dependent variable and covariates from \textit{r}=0.2 to \textit{r}=0.4. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in the FPP and FPR compared to the base model in Figure S7 when using two dependent variables and the average of the two (meaning three dependent variables in total). The correlation between the dependent variables is set to \textit{r}=0.5. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in the FPP and FPR compared to the base model in Figure S7 when using multiple outlier criteria. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in the FPP and FPR comapred to the base model in Figure S7 when using one more covariate (three in total). Black bars denote the added effect to the FPP and red bars denote the added effect to the FPR. The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Effect of increasing sample size for each model set and all combinations of data distributions (i.e., binary and normal). Black denotes the FPP and red denotes the FPR. The description of the figure is otherwise the same as for Figure S7.}
\label{fig:mainfigure}
\end{figure}
