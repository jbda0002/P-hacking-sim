...
\centering
\caption{False positive probability and false positive increasing the correlation between the dependent variable and covariates from covariates and=0.2 to covariates and=0.4. Black denotes the false positive probability and red denotes the false positive ratio. The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
