...
In Figure S12 can be found the FPP and FPR for full model sets under different conditions. Here there is no split between each model set.
...
\centering
\caption{The probability of the FPP and FPR given different model sets, the presence of main effects when having interactions and different distributions of the variable of interest and covariates. Sample size was set to 200, a correlation between the dependent variable and covariates was \textit{r}=0.2 and we used two covariates. The FPP is shown in black and the FPR in red. Here binary variables are both dummy coded but also Effect coded.}
...
\centering
\caption{Difference in FPP and FPR from the base model in Figure S1 when step-wise increasing the correlation between the covariates and the dependent variable from r=0.2 to r=0.4. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in FPP and FPR from the base model in Figure S1 when using two dependent variables and the average of the two (meaning three dependent variables are used). The correlation between the dependent variables is set at r=0.5. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in FPP and FPR from the base model in Figure S1 of using multiple outlier criteria. Black denotes the added effect to the FPP and red denotes the added effect to the FPR.  The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Difference in FPP and FPR from the base model in Figure S1 of using one more covariate (three in total). Black bars are the added effect to the FPP and red denotes the added effect to the FPR. The description of the figure is otherwise the same as for Figure S1.}
\label{fig:mainfigure}
\end{figure}
...
\centering
\caption{Effect of increasing sample size. Black is the FPP and red is FPR.  Here for all combinations of data distribution. The description of the figure is otherwise the same as for Figure S1}
\label{fig:mainfigure}
\end{figure}

\subsection{Result when using Bonferroni correction}
In this section is the same results but using Bonferroni corrections. 
