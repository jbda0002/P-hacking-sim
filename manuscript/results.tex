...
\centering
\caption{Black is the FPP and red is FPR.  Splitting the false-positive by model set and whether the main effects should follow interactions or not. If Main=False, there were no restrictions. Sample size was set to 200, a correlation between the dependent variable and covariates was \textit{r}=0.2 and we used two covariates.}
